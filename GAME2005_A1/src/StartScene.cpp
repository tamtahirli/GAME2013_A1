...
void StartScene::draw()
{
	...
	TextureManager::Instance()->draw("wookie", 400.0f, 300.0f, 0, 255, true);
	drawDisplayList();
}
...
void StartScene::start()
{
	...
	//addChild(new Button("../Assets/textures/background.png", "background", START_BUTTON, glm::vec2(300.0, 400.0f), true));
